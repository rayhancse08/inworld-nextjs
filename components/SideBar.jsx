                ...
                <ul className={styles.menuList}>
                    ...
                    {isDropdownOpen && (
                        <ul className={styles.submenu}>
                            <li className={styles.submenuItem} onClick={() => window.open('/pdfs/Personal_statement_Demo.pdf', '_blank')}>
                                📄 Personal Statement
                            </li>
                    ...
                    <li className={styles.menuItem} onClick={() => window.location.href = '/visa-application'}>🌎 <strong>Countries Visa Application Link</strong></li>
                    <li className={styles.menuItem} onClick={() => window.location.href = '/scholarship-update'}>⚠️ <strong>Scholarship Update</strong></li>
